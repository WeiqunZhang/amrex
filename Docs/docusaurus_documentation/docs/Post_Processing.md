...
The image is produced in the portable pixmap format (.ppm). It can be displayed using the command `display` from [ImageMagick](https://imagemagick.org/index.php) as seen below.
