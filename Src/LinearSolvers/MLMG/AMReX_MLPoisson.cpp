...
//xxxxx    FapplyT(amrlev, mglev, out, in);
}
...
//xxxxx    FsmoothT(amrlev, mglev, sol, rhs, redblack, m_undrrelxr[amrlev][mglev]);
}
...
//xxxxx FsmoothT(amrlev, mglev, sol, rhs, redblack, m_undrrelxr_s[amrlev][mglev]);
}
